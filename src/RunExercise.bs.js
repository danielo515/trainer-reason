...
function make(exercise, onComplete, _) {
  return /* record */[
          ...
          /* render */(function (self) {
              ...
              return React.createElement("div", undefined, message, tmp, React.createElement("br", undefined), "Count " + String(self[/* state */1][/* count */0]), React.createElement("br", undefined), "Rest " + String(self[/* state */1][/* rest */1]), React.createElement("br", undefined), "REPS " + String(self[/* state */1][/* reps */2]), React.createElement("br", undefined), "Remaining " + String(List.length(self[/* state */1][/* series */3])));
            }),
